...
def scrape_data_button_click(stock_symbol, start_date, end_date):
    try:
        # Fetch stock data
        ...
        error_label.config(text=f"Data scraped successfully and saved to {csv_filename}", foreground="green")
...
# Function to handle button click event for data scraping with Selenium
def scrape_data_button_click_with_selenium(stock_symbol, start_date, end_date):
    try:
...
scrape_data_button = ttk.Button(home_tab, text="Scrape Data", command=lambda: scrape_data_button_click("AAPL", '2020-01-01', '2023-12-31'))
scrape_data_button.pack(pady=10)

scrape_data_button_selenium = ttk.Button(home_tab, text="Scrape Data with Selenium", command=lambda: scrape_data_button_click_with_selenium("AAPL", '2020-01-01', '2023-12-31'))
